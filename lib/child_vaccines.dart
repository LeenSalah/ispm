          ...
          child: Column(
            children: [
              ...
              const Align(
                  alignment: Alignment.centerLeft,
                  child: Text(
                    'click on the graph to view history',
              ...
              ListView.builder(physics: const NeverScrollableScrollPhysics(), shrinkWrap: true, itemBuilder: (context, index) => ListTile(title: Text(upcoming[index].name), trailing: Text(upcoming[index].date), tileColor: index % 2 == 0 ? const Color(0xFF135D66) : Colors.transparent, textColor: index % 2 == 0 ? Colors.white: Colors.black,),itemCount: upcoming.length,)
            ],
          ),
        ),
      ),
